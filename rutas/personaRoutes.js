...
router.post('/personas', (req, res) => {
  ...
  // Después de la inserción, puedes responder con el ID de la nueva persona creada o un mensaje de éxito
  // ...
});

// Ruta para actualizar una persona existente
router.put('/personas/:persona_id', (req, res) => {
...
// Ruta para actualizar parcialmente una persona existente
router.patch('/personas/:persona_id', (req, res) => {
  const personaId = req.params.persona_id;
...
router.delete('/personas/:persona_id', (req, res) => {
  const personaId = req.params.persona_id;
